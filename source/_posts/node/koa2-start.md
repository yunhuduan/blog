...
```
要解析和编译 async 方法, 你至少应该有 [transform-async-to-generator][2] 或 [transform-async-to-module-method][3] 插件.
...
以上内容摘自：https://koa.bootcss.com/

  [1]: http://babeljs.io/docs/usage/babel-register/
  [2]: http://babeljs.io/docs/plugins/transform-async-to-generator/
  [3]: http://babeljs.io/docs/plugins/transform-async-to-module-method/
  [4]: https://github.com/koajs/koa/wiki#middleware